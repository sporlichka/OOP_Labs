    ...
    public static void main(String[] args) {
        ...
        for(DukeTransaction transaction:transactions){
            if(polos.containsKey(transaction.getProductID())){
                ...
                System.out.println("something is wrong with ID");
            }
        ...
        // Init Comparators
        Comparator desc = new SortShirtByDesc();
        Comparator count = new SortShirtByCount();
        // Print Results - Sort by Description
        Collections.sort(pololist, desc);
        System.out.println("===Sort by description===");
        for(Shirt shirt:pololist){
            System.out.println(shirt.toString());
        }
        // Print Results - Sort by Count
        Collections.sort(pololist, count);
